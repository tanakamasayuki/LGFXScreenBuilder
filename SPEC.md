...
The header comment at the top of the generated output records the **generating tool version (including `FORMAT_VERSION`) and the targeted library version** (for diagnosing mismatches; this augments the current `// Generated by LGFXScreenBuilder`).
