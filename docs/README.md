...
- **Fonts** mode (SPEC §8.7): browse the preset catalog (`src/font-catalog.js`,
  ...
  rendered px height (the primary filter), category, family, style, script, and
  search — shown as open chip groups so every candidate is visible — adopt a curated subset into the project,
