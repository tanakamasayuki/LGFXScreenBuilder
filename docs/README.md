...
- **Fonts** mode (SPEC §8.7): browse the preset catalog (`src/font-catalog.js`,
  generated by `tests/font_introspect/gen.py` from the pinned LovyanGFX), filter by
  ...
  their own script (日本語 / 简体中文 / 繁體中文 / 한국어). The `tests/font_introspect`
...
- `src/font-catalog.js` — generated preset catalog (by `../tests/font_introspect/gen.py`)
