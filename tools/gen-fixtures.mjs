...
const FIXTURES = [
  {
    ...
    headers: [
      ...
      'examples/MemoryTuningM5Unified/MyScreen.h',
    ],
  ...
  {
    name: 'build_lovyangfx',
    source: 'fixtures/sample.lgfxsb.json',
    headers: ['tests/build_lovyangfx/MyScreen.h'],
  },
  {
...
// Headers generated by hand ON PURPOSE (e.g. shapes the codegen cannot emit).
// Listed so they are never silently assumed to be auto-generated. Currently none.
const HAND_WRITTEN = [];
...
if (import.meta.url === `file://${process.argv[1]}`) {
  ...
  if (HAND_WRITTEN.length) console.log(`hand-written (exempt): ${HAND_WRITTEN.join(', ')}`);
}
